    ...
    <Container fluid>
      <Card>
        ...
        <Row>
          ...
          <Col xs="4">
            <Link to="/" className="btn btn-link btn-lg btn-block mb-4">
              <div>All GIFs</div>
            </Link>
            {imageUrl ? (
              <Col className="text-center">
                <ButtonGroup className="mt-3">
                  ...
                  <Button color="primary" onClick={() => setImageUrl(null)}>
                    Start over
                  </Button>
                </ButtonGroup>
                <CardImg
            ...
            {isCountdownPlaying && (
              <Countdown
                ...
                setIsCountdownPlaying={setIsCountdownPlaying}
            ...
            {isTimerPlaying && (
              <Timer
                isPlaying={isTimerPlaying}
                setIsPlaying={setIsTimerPlaying}
              />
            )}
